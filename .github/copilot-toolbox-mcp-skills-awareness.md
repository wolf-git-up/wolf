...
_Generated: 2026-09-21T03:52:03.084Z_
...
Workspace `mcp.json` _(folder: wolf)_

- **c:\Saran\bikers\wolf\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\venka\AppData\Roaming\Code\User\mcp.json** — _File missing_
